...
public class Meme implements MessageCreateListener {
	...
	public void onMessageCreate(MessageCreateEvent event) {
		...
		memeEmbed
			.setTitle("Here, take a look at this meme.\nHahahaha so funnyy!!!!")
			.setDescription("I found this on facebook")
			.setColor(Color.BLUE)
			.setImage(
				new File(
					String.format(
						"src/minionmemes/%s.jpg",
						Integer.toString(randomGenerator.nextInt(23))
					)
				)
			)
			.setAuthor(
				"My Profile",
				"https://rr.noordstar.me/ac85117e",
				"https://cdn.discordapp.com/embed/avatars/0.png"
			);

		if (
			text[0].equalsIgnoreCase("throw") &&
			text[1].equalsIgnoreCase("meme")
		) {
